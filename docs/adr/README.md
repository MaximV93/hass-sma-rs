...
Numbered narratives of the major choices in hass-sma-rs.

| # | Title | Status |
|---|---|---|
| [0001](0001-protocol-reverse-engineering-narrative.md) | SMA BT protocol reverse-engineering narrative | accepted |
...
| [0005](0005-mis-multi-inverter.md) | MIS multi-inverter polling (repeater + N devices) | accepted |
...
renumber existing ADRs even if deprecated.
